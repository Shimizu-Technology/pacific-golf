...
export const RegistrationSuccessPage: React.FC = () => {
  ...
  if (isLoading) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-brand-50 to-emerald-50 flex items-center justify-center">
                ...
                <div className="flex justify-between text-sm items-center">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    {registration.is_employee && (
                      <span className="inline-flex items-center gap-1.5 px-2.5 py-1 bg-brand-100 text-brand-700 rounded-full text-xs font-semibold">
                        👤 Employee
                      </span>
                    )}
                  </div>
